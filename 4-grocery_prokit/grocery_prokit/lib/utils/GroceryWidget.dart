...
import 'package:grocery_prokit/main.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: text(widget.textContent, textColor: widget.isStroked ? grocery_colorPrimary : grocery_color_white, fontSize: textSizeMedium, isCentered: true, fontFamily: fontSemiBold, textAllCaps: true),
    ...
    if (!widget.isSecure) {
      return TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: UnderlineInputBorder(borderSide: const BorderSide(color: grocery_view_color, width: 0.0)),
          focusedBorder: UnderlineInputBorder(borderSide: const BorderSide(color: grocery_view_color, width: 0.0)),
        ),

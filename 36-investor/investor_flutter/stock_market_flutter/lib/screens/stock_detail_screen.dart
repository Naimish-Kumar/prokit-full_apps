        ...
        leftTitles: AxisTitles(
          sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                switch (value.toInt()) {
                  case 1:
                    return Text('40.00', style: primaryTextStyle(color: white.withOpacity(0.5)));
                  case 2:
                    return Text('50.00', style: primaryTextStyle(color: white.withOpacity(0.5)));
                  case 3:
                    return Text('60.00', style: primaryTextStyle(color: white.withOpacity(0.5)));
                  case 4:
                    return Text('70.00', style: primaryTextStyle(color: white.withOpacity(0.5)));
                  case 5:
                    return Text('80.00', style: primaryTextStyle(color: white.withOpacity(0.5)));
                }
                return Text('');
              },
              reservedSize: 35),

...
import 'package:stock_investment_flutter/screens/face_id_screen.dart';
    ...
    return Wrap(
      ...
      children: [
        OTPTextField(
          ...
          pinLength: 5,
          showUnderline: false,
          decoration: inputDecoration(context).copyWith(filled: true, fillColor: appStore.isDarkModeOn ? dividerDarkColor : gray.withOpacity(0.1)),
        ),
      ],
    );
  }

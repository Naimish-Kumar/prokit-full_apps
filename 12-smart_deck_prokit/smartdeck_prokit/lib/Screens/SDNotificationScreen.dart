...
import 'package:smartdeck_prokit/ModelClass/SDNotidicationModel.dart';
  ...
  Widget build(BuildContext context) {
    Widget mPopup() => PopupMenuButton(
          ...
          child: Container(
            ...
            child: Icon(Icons.more_vert, color: appStore.isDarkModeOn ? white : sdTextPrimaryColor),
          ),
        );
              ...
              child: ListTile(
                leading: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: commonCacheImageWidget(notification[index].images!, height: 35, width: 10, fit: BoxFit.cover),
                  ),
                ),

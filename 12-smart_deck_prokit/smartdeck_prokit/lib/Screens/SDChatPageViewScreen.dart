      ...
      Align(
        ...
        child: FittedBox(
          child: Container(
            ...
            decoration: boxDecorations(bgColor: appStore.isDarkModeOn ? scaffoldDarkColor : sdViewColor),
            child: Text("Today", style: primaryTextStyle(size: 12)).center(),
          ),
        ),
      ),
    );
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Container(
                            ...
                            decoration: boxDecorationWithRoundedCorners(borderRadius: BorderRadius.circular(4), backgroundColor: Colors.white60),
                            child: TextField(
...
Widget ReceivedMessageWidget({required String content, required String time}) {
  return Container(
    child: Padding(
      ...
      child: Container(
        decoration: boxDecorationRoundedWithShadow(8, backgroundColor: appStore.isDarkModeOn ? scaffoldDarkColor : white),
        child: Row(
          children: <Widget>[
            Expanded(
              child: Padding(
                padding: EdgeInsets.only(right: 8.0, left: 8.0, top: 8.0, bottom: 15.0),
                child: Text(
                  content,
                  style: primaryTextStyle(size: 14, color: appStore.isDarkModeOn ? white : Colors.black),
                ),
              ),
            ),

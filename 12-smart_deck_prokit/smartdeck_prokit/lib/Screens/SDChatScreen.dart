...
import 'package:smartdeck_prokit/ModelClass/SDChatsModel.dart';
import 'package:smartdeck_prokit/SDUtils/SDColors.dart';
import 'package:smartdeck_prokit/Screens/SDChatPageViewScreen.dart';
                            ...
                            children: <Widget>[
                              Expanded(
                                child: ListTile(
                                  ...
                                  title: Text(personalChats[index].name!, style: boldTextStyle()),
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              child: ListTile(
                                ...
                                title: Text(groupChats[index].name!, style: boldTextStyle()),

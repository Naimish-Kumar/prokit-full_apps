...
import 'package:smartdeck_prokit/Screens/SDSortScreen.dart';
import 'package:smartdeck_prokit/ModelClass/SDLessonDetailModel.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text('Sort By', style: boldTextStyle(size: 16, color: appStore.isDarkModeOn ? Colors.white : black)),
          icon: Icon(Icons.swap_vert, color: appStore.isDarkModeOn ? Colors.white : black),
        ),
      ),
    );
  }

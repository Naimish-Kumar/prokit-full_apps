...
import 'package:smartdeck_prokit/ModelClass/SDExamModel.dart';
import 'package:smartdeck_prokit/SDUtils/SDColors.dart';
import 'package:smartdeck_prokit/Screens/SDCongratulationsScreen.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: CloseButton(color: appStore.isDarkModeOn ? white : black),
        ),
        title: Container(
          child: Row(

...
import 'package:music_flutter_app/utils/constant.dart';
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      bottomSheetTheme: BottomSheetThemeData(
        shape: RoundedRectangleBorder(borderRadius: radiusOnly(topLeft: DEFAULT_RADIUS, topRight: DEFAULT_RADIUS)),

            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text('Choose artists', style: boldTextStyle(size: 26, color: textPrimaryColorGlobal)),
                  40.height,
                  AnimatedWrap(
                    runSpacing: 20,
                                ...
                                Positioned(
                                  child: Blur(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text('Guy Hawkins', style: secondaryTextStyle(color: textPrimaryColorGlobal)),
                                    ),
                                  ),
                                ),
                            ],

  ...
  Widget _buildTopWidget() {
    return Column(
      children: [
        ...
        30.height,
        Text('Create Your Account', style: boldTextStyle(size: 24, color: textPrimaryColorGlobal)),
        25.height,
      ],
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text('Already have an account?', style: primaryTextStyle(color: textPrimaryColorGlobal)),
                TextButton(
                  onPressed: () {
                    hideKeyboard(context);

...
import 'package:music_flutter_app/utils/string_extensions.dart';
  ...
  Widget _buildTopWidget() {
    return Column(
      children: [
        ...
        30.height,
        Text('Login to Your Account', style: boldTextStyle(size: 24, color: textPrimaryColorGlobal)),
        25.height,
      ],
    );
  }
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              ...
              child: Text('Remember me', style: primaryTextStyle(color: isRemember ? textPrimaryColorGlobal : null)),
            ),
          ],
        ),
        20.height,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text('Don’t have an account?', style: primaryTextStyle(color: textPrimaryColorGlobal)),
                TextButton(
                  onPressed: () {
                    hideKeyboard(context);

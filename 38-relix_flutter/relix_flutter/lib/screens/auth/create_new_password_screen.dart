            ...
            child: Column(
              children: [
                Align(
                  ...
                  child: Text('Create Your New Password', style: primaryTextStyle(color: textPrimaryColorGlobal)),
                ),
                22.height,
                AppTextField(
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text('Remember me', style: primaryTextStyle(color: textPrimaryColorGlobal)),
                    ),
                  ],
                ),
              ],
                    ...
                    return BlurDialogWidget(
                      child: Column(
                        ...
                        children: [
                          ...
                          20.height,
                          Text('Congr atulations!', style: boldTextStyle(color: textPrimaryColorGlobal)),
                          10.height,

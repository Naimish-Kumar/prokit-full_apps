      ...
      body: Stack(
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                Text('Code has been send to (406) *****20', style: primaryTextStyle(color: textPrimaryColorGlobal)),
                30.height,
                OTPTextField(
                  pinLength: 4,
                  fieldWidth: 70,
                ...
                Row(
                  ...
                  children: [
                    Text('Didn’t get the OTP?', style: secondaryTextStyle(color: textPrimaryColorGlobal)),
                    TextButton(
                      onPressed: () {
                        startTimeout();
                      },

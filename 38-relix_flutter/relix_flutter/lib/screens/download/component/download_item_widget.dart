            ...
            Column(
              ...
              children: [
                TextIcon(
                  ...
                  spacing: 0,
                  suffix: Icon(Icons.more_vert, color: textPrimaryColorGlobal).onTap(() {
                    //
                  }, borderRadius: radius(DEFAULT_RADIUS)),
                ),
                4.height,
                Text(widget.modObj!.message.validate(), style: boldTextStyle(), maxLines: 2, overflow: TextOverflow.ellipsis).paddingRight(16),
                8.height,
                RichTextWidget(
                  list: [
        ...
        Row(
          ...
          children: [
            ...
            InkWell(
              ...
              borderRadius: radius(defaultInkWellRadius),
              child: Icon(Icons.play_arrow, size: 28, color: textPrimaryColorGlobal),
            ),
          ],
        ),
      ],

                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(podcastListData.titleName.validate(), style: primaryTextStyle(), maxLines: 2, overflow: TextOverflow.ellipsis),
                        6.height,
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(getEpisodeListData.titleName.validate(), style: boldTextStyle(), maxLines: 2, overflow: TextOverflow.ellipsis),

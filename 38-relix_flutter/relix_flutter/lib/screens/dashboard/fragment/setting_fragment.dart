...
class _SettingFragmentState extends State<SettingFragment> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          6.height,
          Marquee(
            child: Text(text.validate().capitalizeFirstLetter(), style: secondaryTextStyle(color: textPrimaryColorGlobal), textAlign: TextAlign.start, overflow: TextOverflow.ellipsis),
          ),
        ],
      ),
    );
  ...
  Widget buildMiddleWidget() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Your Account', style: boldTextStyle(size: 18)).paddingSymmetric(horizontal: 16),
        10.height,
        SettingItemWidget(
          title: 'Your plan',
  ...
  Widget buildBottomWidget() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Playback', style: boldTextStyle(size: 18)).paddingSymmetric(horizontal: 16),
        10.height,
        SettingItemWidget(
          title: 'Crossfade',
          titleTextStyle: primaryTextStyle(),

              ...
              Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Marquee(child: Text(widget.albumListData!.titleName.validate(), style: boldTextStyle())),
                  ...
                  Row(
                    children: [
                      ...
                      8.width,
                      Marquee(child: Text(widget.albumListData!.subTitleName.validate(), style: primaryTextStyle(size: 14))),
                    ],
                  ),
                  22.height,

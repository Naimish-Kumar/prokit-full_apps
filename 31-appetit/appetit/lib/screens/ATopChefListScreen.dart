              ...
              Row(
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(elevation: 0, backgroundColor: appStore.isDarkModeOn ? context.cardColor : appetitAppContainerColor, shape: StadiumBorder()),
                  ),
                  SizedBox(width: 10),
                  ElevatedButton(
                    onPressed: () {},
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                                alignment: Alignment.center,
                                child: Text(topchefmodal[index].recipe.toString(), style: TextStyle(color: Colors.white, fontSize: 10))),
                          ],
                        ),
                      )
                    ],

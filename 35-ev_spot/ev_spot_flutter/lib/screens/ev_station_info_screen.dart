...
import 'package:ev_spot_flutter/screens/add_check_in_screen.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      boxShadow: [
                        BoxShadow(color: appStore.isDarkMode ? Colors.black : Colors.white, blurRadius: 35, blurStyle: BlurStyle.normal, offset: Offset(0, 1), spreadRadius: 50),
                      ],
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${widget.modelObj!.stTitle != null ? widget.modelObj!.stTitle : " "}', style: boldTextStyle(fontSize: 22)),
                        SizedBox(height: 6),
                        Text(
                        ...
                        Row(
                          ...
                          children: [
                            Text('Open', style: secondaryTextStyle(color: Theme.of(context).colorScheme.primary)),
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(top: 2),
                                child: Icon(Icons.circle, size: 3, color: Theme.of(context).colorScheme.primary),
                              ),
                            ),
                            Expanded(
                              flex: 15,
                            ...
                            GestureDetector(
                              ...
                              child: widget.modelObj!.wishList! ? Icon(Icons.favorite, color: Colors.red, size: 22) : Icon(Icons.favorite_outline, size: 22, color: Theme.of(context).colorScheme.primary),
                            ),
                          ],
                        ),
                        SizedBox(height: 30),
                              ...
                              itemBuilder: (context, index) {
                                return ClipRRect(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      Container(
                                        padding: EdgeInsets.all(DEFAULT_RADIUS),
                                        decoration: BoxDecoration(color: appStore.isDarkMode ? Theme.of(context).colorScheme.surfaceVariant : filterConnColor),
                                        child: Column(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                            boxShadow: [
                                              BoxShadow(
                                                color: appStore.isDarkMode ? Colors.white : Colors.black26,
                                                blurRadius: 30,
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        height: 50,
                        decoration: BoxDecoration(color: appStore.isDarkMode ? Theme.of(context).colorScheme.surfaceVariant : backgroundColor),
                        child: TextButton.icon(
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => AddCheckInScreen()));
                          },
                          icon: Icon(Icons.check_circle_rounded, color: Theme.of(context).colorScheme.primary, size: 20),

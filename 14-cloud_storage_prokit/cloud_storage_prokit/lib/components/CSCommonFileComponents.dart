...
import 'package:cloudstorage_prokit/components/CSCopyAndMoveComponents.dart';
import 'package:cloudstorage_prokit/components/CSDisplayDataInGridViewComponents.dart';
            ...
            return [
              SliverAppBar(
                    ...
                    : [
                        IconButton(
                          ...
                          onPressed: () => showSearch(
                            context: context,
                            delegate: CSSearchBar(hintText: "Searching in Cloudbox", listData: getCloudboxList),
                          ),
                        ),
                        IconButton(
                          color: CSDarkBlueColor,
                ...
                flexibleSpace: FlexibleSpaceBar(
                  title: isSelect
                      ? selectedItem == 0
                          ? Text("Select items", style: boldTextStyle(size: 18))
                          : Text("$selectedItem selected", style: boldTextStyle(size: 18))
                      : Text(widget.appBarTitle!, style: boldTextStyle(size: 18)),
                ),
              ),
            ];
          },
                        ...
                        : Row(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    defaultSortingType.toString().substring(defaultSortingType.toString().indexOf('.') + 1),
                                  ),

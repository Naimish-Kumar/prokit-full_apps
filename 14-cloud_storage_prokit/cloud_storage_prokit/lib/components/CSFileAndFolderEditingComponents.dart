                  ...
                  child: Column(
                    children: [
                      ...
                      dataModel.isFolder
                          ...
                          : lisTileForFileEditingOption(
                              title: "Manage access",
                              leading: blackIcon(Icons.settings),
                            ),
                      buildDivider(isFull: true),
                      lisTileForFileEditingOption(
                      ...
                      dataModel.isStared
                          ? lisTileForFileEditingOption(
                              title: "Unstar",
                              leading: blackIcon(MaterialCommunityIcons.star_off),
                            ).onTap(
                              () {
                                state(
                                  () {
                          ...
                          : lisTileForFileEditingOption(
                              title: "Star",
                              leading: blackIcon(Icons.star_border),
                            ).onTap(
                              () {
                                state(
                                  () {

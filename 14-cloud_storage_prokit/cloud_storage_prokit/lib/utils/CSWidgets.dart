...
import 'package:cloudstorage_prokit/components/CSShareComponents.dart';
...
Widget googleSignInWidget() {
  return Container(
    padding: EdgeInsets.all(10),
    decoration: boxDecorationRoundedWithShadow(5, backgroundColor: appStore.isDarkModeOn ? scaffoldDarkColor : white, spreadRadius: 1, blurRadius: 0, shadowColor: Colors.grey, offset: Offset(0, 1)),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
        Image.asset(CSGoogleLogo, height: 30, width: 30),
        Text("Sign in with Google", style: boldTextStyle()).center().expand(),
      ],
    ),
  );
}
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                createBasicListTile(text: "Create new folder", icon: Icons.folder).onTap(
                  () async {
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: boxDecorationRoundedWithShadow(5, backgroundColor: context.cardColor, spreadRadius: 1, blurRadius: 0, shadowColor: Colors.grey),
                      child: Row(

...
import 'package:cloudstorage_prokit/screens/CSSignInScreen.dart';
import 'package:cloudstorage_prokit/screens/CSWalkthroughScreen1.dart';
...
class CSCreateAccountScreenByEmailState extends State<CSCreateAccountScreenByEmail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("Create a Cloudbox Account", color: context.cardColor),
      body: Center(
        child: Column(
              ...
              children: [
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text: "skg1498@gmail.com.", style: boldTextStyle(size: 19)),
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: "Cloudbox terms",
                          style: TextStyle(color: CSDarkBlueColor, decoration: TextDecoration.underline),
                        ),
                      ],
                    ),
                  ),

...
class CSManageDevicesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("Manage devices", color: context.cardColor),
      body: Container(
            ...
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  title: Text("Android LLD-AL10", style: boldTextStyle(size: 16)),
                  subtitle: Text("This device", style: primaryTextStyle()),
              ...
              Container(
                ...
                color: Colors.grey,
                child: Text("Unlink", style: boldTextStyle()),
              ).onTap(() {
              ...
              8.height,
              Text("Link more devices with Plus", style: boldTextStyle(size: 16)),
              8.height,
              Text(
              ...
              Container(
                ...
                child: Container(
                  ...
                  width: double.infinity,
                  child: TextButton(
                    child: Text("Try Plus for free", style: boldTextStyle()),
                    onPressed: () {

...
import 'package:cloudstorage_prokit/screens/CSConnectWithComputerScreen.dart';
...
class CSWalkthroughScreen2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("", color: context.cardColor),
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Image.network(CSCloudboxLogo, height: 200),
              Wrap(
                children: [
                  Text(
              ...
              Text(
                "Email me a link",
                style: primaryTextStyle(size: 18, color: CSDarkBlueColor, decoration: TextDecoration.underline),
              ),
              Container(
                height: 50,

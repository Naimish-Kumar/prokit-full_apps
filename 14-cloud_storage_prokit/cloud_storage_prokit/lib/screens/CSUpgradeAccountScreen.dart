    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0, bottom: 80),
            child: Column(
              children: [
                Image.network(CSCloudboxLogo, height: 150, width: 150),
                Text("Do more with Cloudbox Plus", style: boldTextStyle()).paddingOnly(top: 10, bottom: 10),
                buildListTileForUpgradeAccount(
                  "Automatically back up your camera roll to keep your photos and videos safe",
                ),
                buildListTileForUpgradeAccount(
                  "2 TB (2,000 GB) of space for all your important memories and work",
                ),
                buildListTileForUpgradeAccount(
                  "Easily save, view, and share files on your phone and computer anywhere",
                ),
